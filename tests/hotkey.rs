...
// #[cfg(test)]
    ...
    fn test_keyseq_macro() {
        ...
        assert_eq!(vec![Key(Modifiers::empty(), KeyCode::A),
    ...
    fn test_key_macro() {
        ...
        assert_eq!(Key(Modifiers::Control, KeyCode::Backslash), key!{ ctrl-'\\' });
        assert_eq!(Key(Modifiers::Control, KeyCode::Escape), key!{ ctrl-Escape });
        ...
        assert_eq!(Key(Modifiers::Control | Modifiers::Alt, KeyCode::Colon), key!{ ctrl-alt-: });
        assert_eq!(Key(Modifiers::Control | Modifiers::Alt, KeyCode::Slash), key!{ ctrl-alt-/ });
    ...
    fn test_keyseq() {
        ...
        assert_eq!(vec![Key(Modifiers::empty(), KeyCode::A),
                   Key(Modifiers::empty(), KeyCode::B)], keyseq!{ A B});
    }
